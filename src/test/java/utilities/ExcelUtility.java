...
/**
 * Utility class for reading/writing Excel files using Apache POI.
 * Supports row count, cell count, reading, writing, and cell color fill.
 */
public class ExcelUtility {
    ...
    // Get cell data as string (handles numeric, string, etc.)
    ...
    // Set cell data in given sheet, row, col
